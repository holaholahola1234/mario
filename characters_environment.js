...
var mario, bricks,clouds,mountains,enemyMushrooms,pipes,platforms,coins,collide;
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Presiona el boton para iniciar el juego", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
